<div class="video-container position-relative bg-dark rounded overflow-hidden shadow-lg w-100" style="min-height: 400px; display: flex; align-items: center; justify-content: center; background-color: #000;">
    ...
    <img id="video-stream" src="http://172.16.151.161:5000/video" alt="Flux Vid&eacute;o Robot" class="w-100" style="height: auto; min-height: 400px; object-fit: cover;"
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        img.onerror = function() {
            ...
            this.src = "http://" + window.location.hostname + ":5000/video";
        };
    });
</script>